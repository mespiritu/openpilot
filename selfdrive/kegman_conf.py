...
class kegman_conf():
  ...
  def read_config(self):
    ...
    if os.path.isfile('/data/kegman.json'):
      ...
      self.config = {"cameraOffset":"0.06", "lastTrMode":"1", "battChargeMin":"65", "battChargeMax":"55", "wheelTouchSeconds":"1800", "battPercOff":"25", "carVoltageMinEonShutdown":"11200", "brakeStoppingTarget":"0.25", "angle_steers_offset":"0" , "brake_distance_extra":"1" , "lastALCAMode":"1" , "brakefactor":"1.2"}
      self.write_config(self.config)
    return self.config
